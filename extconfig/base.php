...
abstract class phpbb_ext_gallery_core_extconfig_base implements phpbb_ext_gallery_core_extconfig_interface
{
	/**
	...
	*/
	...
	public function __construct(phpbb_config $config, $db, $table)
	{
	...
	*/
	final public function get_config_name($config_name)
	{
		...
		$tmp_name = $this->get_prefix_for_set('core') . $config_name;
		return isset($config_names[$tmp_name]) && $config_names[$tmp_name];
	}
