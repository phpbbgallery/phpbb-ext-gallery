...
abstract class database_test_case extends \phpbb_database_test_case
{
	...
	{
		return new \phpbbgallery\core\tests\testframework\gallery_database_test_connection_manager($config);
	}

	public function get_database_config()
	{
		$config = \phpbbgallery\core\tests\testframework\gallery_test_case_helpers::get_test_config();
